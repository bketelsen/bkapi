...
![Elevated Access Powershell](wsl/wsl-powershell-admin)
...
![Ubuntu](wsl/microsoft-store-ubuntu)
...
![Windows Terminal](wsl/windows-terminal)

- Open the `Ubuntu` app from your Start menu

![ubuntu](wsl/wsl-first-run)
...
![remote](wsl/vscode-remote-extensionpack)
...
![default](wsl/terminal-default-profile)
...
![Windows Explorer](wsl/explorer-integration)
...
![Docker from Both Sides](docker-two-sides)
